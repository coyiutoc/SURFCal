...
INSERT INTO Items (itemId, calendarId, name, createDate, note, reminder, type, createdBy, location, colour) VALUES
    ...
    (11, 6, 'task1', '2018-05-22', 'sample text 1', NULL, 'task', 1, 'Vancouver', 1),
    (12, 6, 'task2', '2018-05-21', 'sample text 2', NULL, 'task', 1, 'Vancouver', 1),
    (13, 6, 'task3', '2018-04-05', 'sample text 3', '2018-04-06 00:00:00', 'task', 3, 'Vancouver', 1),
    (14, 6, 'task4', '2018-05-25', 'sample text 4', NULL, 'task', 1, 'Vancouver', 1),
    (15, 6, 'task5', '2018-05-20', 'sample text 5', NULL, 'task', 1, 'Vancouver', 1),
    (16, 6, 'task6', '2018-04-03', 'sample text 6', '2018-04-06 00:00:00', 'task', 3, 'Vancouver', 1),
    (17, 6, 'task7', '2018-05-19', 'sample text 7', NULL, 'task', 1, 'Vancouver', 1),
    (18, 6, 'task8', '2018-05-14', 'sample text 8', NULL, 'task', 1, 'Vancouver', 1),
    (19, 6, 'task9', '2018-04-12', 'sample text 9', '2018-04-06 00:00:00', 'task', 4, 'Vancouver', 1),
    (20, 6, 'task10', '2018-05-05', 'sample text 10', NULL, 'task', 1, 'Vancouver', 1),
    (21, 6, 'note1', '2018-05-25', 'sample text 1', NULL, 'note', 1, 'Vancouver', 1),
    (22, 6, 'note2', '2018-05-21', 'sample text 2', NULL, 'note', 1, 'Vancouver', 1),
    (23, 6, 'note3', '2018-04-05', 'sample text 3', '2018-06-06 00:00:00', 'note', 1, 'Vancouver', 1),
    (24, 6, 'note4', '2018-05-24', 'sample text 4', NULL, 'note', 5, 'Vancouver', 1),
    (25, 6, 'note5', '2018-05-22', 'sample text 5', NULL, 'note', 1, 'Vancouver', 1),
    (26, 6, 'note6', '2018-04-07', 'sample text 6', '2018-06-06 00:00:00', 'note', 1, 'Vancouver', 1),
    (27, 6, 'note7', '2018-05-30', 'sample text 7', NULL, 'note', 1, 'Vancouver', 1),
    (28, 6, 'note8', '2018-05-05', 'sample text 8', NULL, 'note', 5, 'Vancouver', 1),
    (29, 6, 'note9', '2018-04-25', 'sample text 9', '2018-06-06 00:00:00', 'note', 1, 'Vancouver', 1),
    (30, 6, 'note10', '2018-03-23', 'sample text 10', NULL, 'note', 1, 'Vancouver', 1),
    (31, 6, 'reminder1', '2018-05-22', 'sample text 1', NULL, 'reminder', 1, 'Vancouver', 1),
    (32, 6, 'reminder2', '2018-05-21', 'sample text 2', NULL, 'reminder', 2, 'Vancouver', 1),
    (33, 6, 'reminder3', '2018-04-05', 'sample text 3', '2018-04-06 00:00:00', 'reminder', 1, 'Vancouver', 1),
    (34, 6, 'reminder4', '2018-05-25', 'sample text 4', NULL, 'reminder', 1, 'Vancouver', 1),
    (35, 6, 'reminder5', '2018-05-20', 'sample text 5', NULL, 'reminder', 1, 'Vancouver', 1),
    (36, 6, 'reminder6', '2018-04-03', 'sample text 6', '2018-04-06 00:00:00', 'reminder', 1, 'Vancouver', 1),
    (37, 6, 'reminder7', '2018-05-19', 'sample text 7', NULL, 'reminder', 2, 'Vancouver', 1),
    (38, 6, 'reminder8', '2018-05-14', 'sample text 8', NULL, 'reminder', 3, 'Vancouver', 1),
    (39, 6, 'reminder9', '2018-04-12', 'sample text 9', '2018-04-06 00:00:00', 'reminder', 1, 'Vancouver', 1),
    (40, 6, 'reminder10', '2018-05-05', 'sample text 10', NULL, 'reminder', 1, 'Vancouver', 1);
