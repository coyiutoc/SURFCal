...
INSERT INTO Items (itemId, calendarId, name, createDate, note, reminder, type, createdBy, location, colour) VALUES
    ...
    (41, 1, 'event1', '2018-05-25', 'sample text 1', NULL, 'event', 1, 'Vancouver', 1),
    (42, 1, 'event2', '2018-05-21', 'sample text 2', NULL, 'event', 1, 'Vancouver', 1),
    (43, 2, 'event3', '2018-04-05', 'sample text 3', '2018-06-06 00:00:00', 'event', 2, 'Vancouver', 1),
    (44, 2, 'event4', '2018-05-24', 'sample text 4', NULL, 'event', 1, 'Vancouver', 1),
    (45, 3, 'event5', '2018-05-22', 'sample text 5', NULL, 'event', 1, 'Vancouver', 1),
    (46, 4, 'event6', '2018-04-07', 'sample text 6', '2018-06-06 00:00:00', 'event', 1, 'Vancouver', 1),
    (47, 4, 'event7', '2018-05-30', 'sample text 7', NULL, 'event', 1, 'Vancouver', 1),
    (48, 5, 'event8', '2018-05-05', 'sample text 8', NULL, 'event', 1, 'Vancouver', 1),
    (49, 5, 'event9', '2018-04-25', 'sample text 9', '2018-06-06 00:00:00', 'event', 1, 'Vancouver', 1),
    (50, 5, 'event10', '2018-03-23', 'sample text 10', NULL, 'event', 3, 'Vancouver', 1),
    (51, 1, 'task1', '2018-05-22', 'sample text 1', NULL, 'task', 1, 'Vancouver', 2),
    (52, 1, 'task2', '2018-05-21', 'sample text 2', NULL, 'task', 1, 'Vancouver', 2),
    (53, 2, 'task3', '2018-04-05', 'sample text 3', '2018-04-06 00:00:00', 'task', 3, 'Vancouver', 2),
    (54, 2, 'task4', '2018-05-25', 'sample text 4', NULL, 'task', 1, 'Vancouver', 2),
    (55, 3, 'task5', '2018-05-20', 'sample text 5', NULL, 'task', 1, 'Vancouver', 2),
    (56, 3, 'task6', '2018-04-03', 'sample text 6', '2018-04-06 00:00:00', 'task', 3, 'Vancouver', 2),
    (57, 4, 'task7', '2018-05-19', 'sample text 7', NULL, 'task', 1, 'Vancouver', 2),
    (58, 4, 'task8', '2018-05-14', 'sample text 8', NULL, 'task', 1, 'Vancouver', 2),
    (59, 5, 'task9', '2018-04-12', 'sample text 9', '2018-04-06 00:00:00', 'task', 4, 'Vancouver', 2),
    (60, 5, 'task10', '2018-05-05', 'sample text 10', NULL, 'task', 1, 'Vancouver', 2),
    ...
    (81, 1, 'reminder1', '2018-05-22', 'sample text 1', NULL, 'reminder', 1, 'Vancouver', 3),
    (82, 1, 'reminder2', '2018-05-21', 'sample text 2', NULL, 'reminder', 2, 'Vancouver', 3),
    (83, 2, 'reminder3', '2018-04-05', 'sample text 3', '2018-04-06 00:00:00', 'reminder', 1, 'Vancouver', 3),
    (84, 2, 'reminder4', '2018-05-25', 'sample text 4', NULL, 'reminder', 1, 'Vancouver', 3),
    (85, 3, 'reminder5', '2018-05-20', 'sample text 5', NULL, 'reminder', 1, 'Vancouver', 3),
    (86, 3, 'reminder6', '2018-04-03', 'sample text 6', '2018-04-06 00:00:00', 'reminder', 1, 'Vancouver', 3),
    (87, 4, 'reminder7', '2018-05-19', 'sample text 7', NULL, 'reminder', 2, 'Vancouver', 3),
    (88, 4, 'reminder8', '2018-05-14', 'sample text 8', NULL, 'reminder', 3, 'Vancouver', 3),
    (89, 5, 'reminder9', '2018-04-12', 'sample text 9', '2018-04-06 00:00:00', 'reminder', 1, 'Vancouver', 3),
    (90, 5, 'reminder10', '2018-05-05', 'sample text 10', NULL, 'reminder', 1, 'Vancouver', 3);
